...
public class Quiz1 implements ActionListener {
    ...
    String[] questions = { "  In Time Variant control system______________",
            ...
            "Which of the following is an example of systems using feedback?",
            "Choose which of the following is the advantage open loop control system:",
            " In Time Variant control system______________", "Effect of feedback on sensitivity is minimum in:",
    ...
    String[][] options = {
            { "Parameters change with frequency", " Parameters change with time",
                    " Parameters depend on time for certain amount of time", "Parameters don’t depend on time " },
            ...
            { "Air Conditioner,Rocket", " A cup of Coffee , Heater", " Electric Bulb , Washing machine",
                    " Missile Launcher ,Automatic toaster" },
            { "Simple and economical", "Accurate", "Reliable", "All of the above" },
            { "Parameters change with frequency", "Parameters change with time",
                    " Parameters depend on time for certain amount of time", "Parameters don’t depend on time" },
            { "Open loop control system", "Closed loop control system", "None of the mentioned",
                    " Both of the mentioned" },
            { "Gain", "Bandwidth", "Frequency", "Speed" } };
    char[] answers = { 'B', 'B', 'B', 'D', 'D', 'A', 'A', 'B', 'B', 'B' };
    char guess;
    char answer;
    int index;
